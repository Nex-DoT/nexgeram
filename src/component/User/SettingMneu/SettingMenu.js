...
const SettingMenu = () => {
    ...
    return (
        ...
        {/* //Menu */}
            <div className={menu ? ' drop-shadow-lg w-64 h-full bg-gray-800 text-white absolute left-0 top-0 flex flex-col justify-around pb-80 transition-all opacity-100' : " drop-shadow-xl opacity-0 -left-1/2 transition-all w-64 h-full bg-gray-800 text-white absolute top-0 flex flex-col justify-around pb-80"} >
                <div className='p-3'>
